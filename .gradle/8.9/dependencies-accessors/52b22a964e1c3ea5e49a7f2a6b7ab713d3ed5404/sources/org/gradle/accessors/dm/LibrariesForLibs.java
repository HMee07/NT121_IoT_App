...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxActivityComposeLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v192</b> with <b>androidx.activity:activity-compose</b> coordinates and
         * with version reference <b>activityComposeVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV192() {
            return create("androidx.activity.compose.v192");
        }
    ...
    public static class AndroidxComposeBomLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v20230901</b> with <b>androidx.compose:compose-bom</b> coordinates and
         * with version reference <b>composeBomVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV20230901() {
            return create("androidx.compose.bom.v20230901");
        }
    ...
    public static class AndroidxComposeUiUiLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Group of libraries at <b>androidx.compose.ui.ui.test</b>
         */
    ...
    public static class AndroidxComposeUiUiToolingLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>preview2</b> with <b>androidx.compose.ui:ui-tooling-preview</b> coordinates and
         * with <b>no version specified</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getPreview2() {
            return create("androidx.compose.ui.ui.tooling.preview2");
        }
    ...
    public static class AndroidxUiLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v153</b> with <b>androidx.compose.ui:ui</b> coordinates and
         * with version reference <b>uiVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV153() {
            return create("androidx.ui.v153");
        }
    ...
    public static class FirebaseBomLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v3223</b> with <b>com.google.firebase:firebase-bom</b> coordinates and
         * with version reference <b>firebaseBomVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV3223() {
            return create("firebase.bom.v3223");
        }
    ...
    public static class GoogleFirebaseLibraryAccessors extends SubDependencyFactory {
        private final GoogleFirebaseDatabaseLibraryAccessors laccForGoogleFirebaseDatabaseLibraryAccessors = new GoogleFirebaseDatabaseLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>google.firebase.database</b>
         */
        public GoogleFirebaseDatabaseLibraryAccessors getDatabase() {
            return laccForGoogleFirebaseDatabaseLibraryAccessors;
        }

    }

    public static class GoogleFirebaseDatabaseLibraryAccessors extends SubDependencyFactory {

        public GoogleFirebaseDatabaseLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
         ...
         */
        public Provider<MinimalExternalModuleDependency> getKtx() {
            return create("google.firebase.database.ktx");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>activityComposeVersion</b> with value <b>1.9.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>composeBomVersion</b> with value <b>2023.09.01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>firebaseBomVersion</b> with value <b>32.2.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>material3Version</b> with value <b>1.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>uiVersion</b> with value <b>1.5.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
